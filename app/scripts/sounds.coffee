define ['jsfxlib'], (jsfxlib) ->
  sounds =
    ...
    error: ["saw",0.0000,0.4000,0.0000,0.2900,0.0000,0.3540,784.0000,86.0000,20.0000,0.3940,0.0000,0.0000,0.0100,0.0003,0.0000,0.0000,0.0000,0.0000,0.0000,0.4744,0.0000,0.0000,1.0000,0.0000,0.0000,0.0000,0.0000]
